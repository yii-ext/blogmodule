    ...
    <table class="table table-striped table-bordered">
        ...
        <tr data-key="1">
            ...
            <td>
                ...
                <a href="<?=\Yii::$app->getUrlManager()->createUrl(['adminblog/catalog/update', 'id' => $item['id']]);?>"" title="<?=Module::t('blog', 'Update');?>" data-pjax="0"><span class="glyphicon glyphicon-pencil"></span></a>
